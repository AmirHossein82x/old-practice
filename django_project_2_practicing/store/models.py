...
class Collection(models.Model):
    ...
    featured_product = models.ForeignKey('Product', related_name='+', on_delete=models.CASCADE, null=True)
...
class Customer(models.Model):
    ...
    # last_name = models.CharField(max_length=255)  because they exists in the user model
